    ...
    <>
      <Card className="flex flex-col h-[90vh] max-w-[90%] mx-auto p-6 shadow-lg">
        ...
        <CardHeader className="border-b px-6 py-4">
          <CardTitle className="text-xl text-primary">Chatea con tus documentos</CardTitle>
        </CardHeader>
            ...
            <Message key={index} role={message.role}>
              {message.role === "assistant" ? (
                ...
                <Markdown
                  ...
                  rehypePlugins={[rehypeRaw]} // Permite renderizar HTML en Markdown (opcional)
                >
                  {message.content}
                </Markdown>
      ...
      Esto puede tomar unos segundos, por favor espera mientras analizamos la información.`}
              </Markdown>
            </Message>
          )}
